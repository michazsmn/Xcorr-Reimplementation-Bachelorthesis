...
Suppose a scan retrieved from the mzML file has a mass of 2188.8979. With a tolerance of 20ppm this would mean a tolerance between 2093.0724 and 2284.72338 dalton. The binary search function would return the index [35] as the lower, and [38] as the upper index. A slice of peptides is taken  from this peptide index list as \textit{peptide\_index[35:38]}, which means the sliced list contains the peptides with the indices 35-37.
\cref{fig:peptindex}.
