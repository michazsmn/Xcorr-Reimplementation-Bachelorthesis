...
To compare the execution times of comet and this implementation, a small fasta database file was created. This fasta file contains the top 110 peptides that matched in the initial comet run. The execution times are shown in \cref{tab:speed-comparison}.
...
Comet uses multiple scores to evaluate peptide matches, so on of the key points for future work is implementing more scores in this implementation as well.

To increase the speed of this implementation, it is necessary to implement a fast scoring array manipulation.
