...
A theoretical spectrum of a peptide from a database is created by b and y series!!!!!!
...
\label{fig:peptindex}
\end{wrapfigure}
It is first checked whether the MS level is 2, if it is the case, the program iterates over all possible precursors and selected ions, where it first calculates the mass in dalton of the selected ion.
...
For description of the written code, the numpy styled documentation "numpydoc" was used. Based on this, documentation with sphinx is generated.
