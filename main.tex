...
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth]{figs/scan_71120_ps=False.png}
\caption{Plot of experimental processed spectrum and theoretical spectrum for scan 71220 in \cref{fig:output}}
\label{fig:71120theo}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth]{figs/scan_71120_ps=True.png}
\caption{Plot of experimental processed spectrum and predicted spectrum for scan 71220 in \cref{fig:output}}
\label{fig:71120predict}
\end{figure}
