...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.47\textwidth}
         ...
         \label{fig:y-ions}
     \end{subfigure}
    \caption{b and y ions for the peptide "GLSDGEWQQVLNVWGK" \cref{fig:b-y-ions}.}
    \label{fig:b-y-ions}
\end{figure}
...
\caption{Fragmentation table for the peptide "GLSDGEWQQVLNVWGK" with charge state 1 \cref{fig:b-y-ions}.}
...
The m/z of each b and y ion for this peptide are shown in \cref{fig:fragment-table} for the charge state 1. These values are forming the theoretical spectrum of the peptide. 
...
it can have a drawback: Theoretical spectra are always correct for a given peptide, that means given a peptide and a precursor charge state, an unambigous theoretical spectrum can be generated. Peptide intensity prediction on the other hand has a small chance of predicting the m/z values as well as the corresponding intensities wrong.
