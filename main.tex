...
An example for a good match is shown in [\cref{fig:predandtheo_71120}]. %This comparison was made without the window normalisation step described in section \ref{SpectBinningChapter}, and normalisation was performed over the entire m/z interval. 
...
\centering
   ...
   \label{fig:predict}
\end{subfigure}
\caption{Experimental and theoretical/predicted spectra of the peptide "AFLADPSAFVAAAPVAAATTAAPAAAAAPAK" for scan 130781 in [\cref{fig:output}] . The x-axis represents the binned m/z array indices, the y-axis the intensities normalised between 0 and 50. Red colored spectra are represented negative only for visualization purposes.}
